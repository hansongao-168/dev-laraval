...
- 《深入设计模式》Dive Into Design Patterns（Alexander Shvets / Refactoring.Guru，中文版 v2020-1.20）→ 书摘：[[30-Resources/books/深入设计模式/书评]]、[[30-Resources/books/深入设计模式/章节/装饰器-Decorator-精读]]
